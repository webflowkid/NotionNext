...
const BLOG = {
  AUTHOR: 'tenten', // 作者
  BIO: 'Digital Agency - No Code/ Webflow Expert', // 作者简介
  LINK: 'https://blog.clubmunger.com', // 网站地址
  KEYWORDS: 'Notion CMS, No Code Agency, Webflow Agency', // 网站关键词 英文逗号隔开
  NOTION_PAGE_ID:
  ...
  CONTACT_EMAIL: 'hello@clubmunger.com',
  CONTACT_WEIBO: 'clubmunger',
  CONTACT_TWITTER: 'clubmunger',
  CONTACT_GITHUB: 'https://github.com/webflowkid',
  CONTACT_TELEGRAM: 'clubmunger',
